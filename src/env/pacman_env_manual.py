# This one is a copy of pacman_env.py and manually adopted to use gymnasium
...
class PacmanEnv(gym.Env):
    ...
    def __init__(self, layout: str = 'classic', render_mode: str = 'human', enable_render=True, state_active=False, player_lives: int = 3):
        """
        ...
        self.observation_space = spaces.Box(low=0, high=255, shape=self.get_screen_rgb_array().shape, dtype=int)
    ...
    def reset(self, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        if self.render_mode == 'human':
            ...
            return self.get_screen_rgb_array(), self.get_info_dict()
